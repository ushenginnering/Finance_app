...
<head>
	...
	<title>Investment Transactions - Admin Dashboard</title>
	<!-- Bootstrap css -->
		...
		<div class="page-content">
			...
			<div class="page-header">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Investment Transactions Section</li>
				</ol>
				...
				<div class="row gutters">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="alert alert-info alert-dismissible fade show" role="alert">
							Admin to view all Investment Transactions on the system
