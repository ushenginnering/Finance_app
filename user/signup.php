					...
					<div class="login-screen">
						...
						<div class="login-box">
							...
							<div class="custom-control custom-switch mb-3">
								...
								<label class="custom-control-label" for="customSwitch1">I agree to the company <a href="">Terms and conditions</a></label>
							</div>
							...
							<hr>
							<div class="m-0">
								<span class="additional-link">Already Have an account? 
									<a href="login.php" class="btn btn-dark">Login</a></span>
							</div>
						</div>
					</div>
				</div>
